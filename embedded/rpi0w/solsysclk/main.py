...
def planet_timestamp(name, action, ts, planets, city, eph, names):
    ...
    # make hours 24+3 because during spring, next sunset will be more than 24h later than current, and moonrises and sets can be *over* one hour later the next day.
